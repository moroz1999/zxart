...
class AiManager
{
     ...
     */
    public function getProdData(zxProdElement $element): array|ArrayAccess|null|null
    {
        $output = null;
...
";
     ...
     */
    private function sendPromt(string $promt, float $temperature, string $log, array $prodData): string|false|null
    {
