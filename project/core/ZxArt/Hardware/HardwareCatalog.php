...
/**
 * Single source of truth for hardware item grouping.
 */
final class HardwareCatalog
{
    /**
     * @return array<string, string[]> group value => list of item values
     */
    ...
    /**
     * @return string[] item values belonging to the given group
     */
    ...
    {
        foreach ($this->getGroupedItems() as $groupValue => $items) {
            if (in_array($item, $items, true)) {
                return HardwareGroup::from($groupValue);
            }
        }
