...
use ZxArt\Prods\Rest\ProdMapsRestDto;

class ProdMaps extends LoggedControllerApplication
{
    ...
    public function execute($controller): void
    {
        try {
            ...
            $dto = $this->prodMediaService->getProdMaps($elementId);
            $this->renderer->assign('body', $this->objectMapper->map($dto, ProdMapsRestDto::class));
        } catch (ProdDetailsException $e) {
            $this->logThrowable('ProdMaps::execute', $e);
