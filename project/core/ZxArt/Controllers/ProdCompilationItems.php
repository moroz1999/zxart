...
class ProdCompilationItems extends LoggedControllerApplication
{
    ...
    public function __construct(
        ...
        Logger $logger,
        private readonly ProdRelatedProdsService $prodRelatedProdsService,
    ...
    public function execute($controller): void
    {
        try {
            ...
            $dto = $this->prodRelatedProdsService->getCompilationItems($elementId);
            $this->renderer->assign('body', $this->objectMapper->map($dto, ProdSummariesRestDto::class));
        } catch (ProdDetailsException $e) {
            $this->logThrowable('ProdCompilationItems::execute', $e);
