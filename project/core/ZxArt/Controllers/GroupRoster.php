...
use ZxArt\Groups\Services\GroupRosterService;
use ZxArt\Prods\Exception\ProdDetailsException;

class GroupRoster extends LoggedControllerApplication
{
    ...
    {
        try {
            $dto = $this->groupRosterService->getRoster($this->getGroupId());
            $this->renderer->assign('body', $this->objectMapper->map($dto, GroupRosterRestDto::class));
        } catch (ProdDetailsException $e) {
            $this->logThrowable('GroupRoster::execute', $e);
