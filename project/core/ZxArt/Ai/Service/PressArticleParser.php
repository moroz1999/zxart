...
* Названия программ и групп переделывай из капслока в удобные для чтения, если это не аббревиатуры. Например, PSG - похоже на аббревиатуру, оставь капслок. DREAM TEAM - явно не аббревиатура, переделай в Dream Team.
...
* Убирай из названия программ версии под память 128 и 48. Пример 'Empire 128' должна стать просто 'Empire'.
