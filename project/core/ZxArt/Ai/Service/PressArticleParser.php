...
* Если в статье указаны авторы всего ЖУРНАЛА или ГАЗЕТЫ, то собери их id и роли (если есть) в pressAuthorship в формате AuthorshipObj и SoftwareRole.
...
* Если в названии командыы, автора, пати или софта есть апостроф с цифрами в конце, то распознавай это как год в отдельном поле year. В названии год убирай. Например, Dihalt'99 - это Dihalt, который был в 1999 году. Например, RUSH'98 - это продукция команды Rush, выпущенная в 1998 году. 
