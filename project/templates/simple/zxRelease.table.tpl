...
{include file=$theme->template("component.languagelinks.tpl") element=$element} {$element->version} {if $element->releaseType}{translations name="zxRelease.type_{$element->releaseType}"}{/if} <br>
