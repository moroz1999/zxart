<div class="center_column" role="main">
    ...
    {else}
        {if $currentElement->getTemplate() !== 'zxProd.details.tpl' && $currentElement->getTemplate() !== 'zxRelease.details.tpl' && $currentElement->getTemplate() !== 'author.details.tpl' && $currentElement->getTemplate() !== 'authorAlias.details.tpl'}
