		...
		<div class='settings_block'>
			{if $currentMode.hidden === '0'}
				<div>
					...
					{if $currentMode.mode == 'mix' || $currentMode.mode == 'public'}
						<b>Mix</b>
						<input type="button" class="button button_xs"  data-operation='border:{$currentMode.border}/mode:flicker' value="Flicker" />
						<input type="button" class="button button_xs"  data-operation='border:{$currentMode.border}/mode:interlace1' value="int1" />
						<input type="button" class="button button_xs"  data-operation='border:{$currentMode.border}/mode:interlace2' value="int2" />
					{elseif $currentMode.mode == 'flicker'}
						<input type="button" class="button button_xs"  data-operation='border:{$currentMode.border}/mode:mix' value="Mix" />
						<b>Flicker</b>
						<input type="button" class="button button_xs"  data-operation='border:{$currentMode.border}/mode:interlace1' value="int1" />
						<input type="button" class="button button_xs"  data-operation='border:{$currentMode.border}/mode:interlace2' value="int2" />
				...
				<div>
					...
					{if $currentMode.border === '1'}
						<b>ON</b>
						<input type="button" class="button button_xs"  data-operation='border:0/mode:{$currentMode.mode}' value="OFF" />
					{else}
						<input type="button" class="button button_xs"  data-operation='border:1/mode:{$currentMode.mode}' value="ON" />
						<b>OFF</b>
					{/if}
				</div>
			{/if}
			<div>
				...
				{if $currentMode.hidden === '1'}
					<b>ON</b>
					<input type="button" class="button button_xs"  data-operation='hidden:0' value="OFF" />
				{else}
					<input type="button" class="button button_xs"  data-operation='hidden:1' value="ON" />
					<b>OFF</b>
				{/if}
			</div>
		</div>
