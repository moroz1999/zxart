...
<form action="{$element->URL}" method="post" class="group_form" enctype="multipart/form-data">
    <table class='form_table'>
        ...
        <tr{if $formErrors.abbreviation} class="form_error"{/if}>
            ...
            <td class="form_field">
                <input class='input_component' type="text" value="{$formData.abbreviation}"
        ...
        <tr{if $formErrors.startDate} class="form_error"{/if}>
            ...
            <td class="form_field">
                <input class='input_component' type="text" value="{$formData.startDate}" name="{$formNames.startDate}"
                       onfocus="displayCalendar(this,'dd.mm.yyyy',this);"/>
        ...
        <tr>
            ...
            <td class="form_field">
                <select class="select_multiple group_form_subgroup_select" multiple='multiple'
                        name="{$formNames.subGroupsSelector}[]" autocomplete='off'>
                    <option value=''></option>
                    {foreach from=$subGroups item=subgroup}
                        <option value="{$subgroup->id}" selected="selected">
                            {$subgroup->getSearchTitle()}
                        </option>
                    {/foreach}
                </select>
