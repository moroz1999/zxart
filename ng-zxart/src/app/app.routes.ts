...
const ROUTED_CHILDREN: Routes = [
  ...
  {path: 'artists', loadComponent: () => import('./pages/authors/authors-page.component').then(m => m.AuthorsPageComponent), data: {items: 'graphics', basePath: '/artists', titleKey: 'author-browser.title.graphics'}},
  ...
  {path: 'musicians', loadComponent: () => import('./pages/authors/authors-page.component').then(m => m.AuthorsPageComponent), data: {items: 'music', basePath: '/musicians', titleKey: 'author-browser.title.music'}},
  ...
  {path: 'geo', loadComponent: () => import('./pages/countries/countries-page.component').then(m => m.CountriesPageComponent), data: {titleKey: 'menu.countries'}},
