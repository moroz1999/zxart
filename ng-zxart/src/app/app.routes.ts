...
const ROUTED_CHILDREN: Routes = [
  ...
  {
    path: 'pictures/top',
    loadComponent: () => import('./pages/top-pictures/top-pictures-page.component').then(m => m.TopPicturesPageComponent),
    data: {titleKey: 'menu.gfx.top'},
    children: [{path: ':filter', children: [], data: {titleKey: 'menu.gfx.top'}}],
  },
  ...
  {
    path: 'music/top',
    loadComponent: () => import('./pages/top-music/top-music-page.component').then(m => m.TopMusicPageComponent),
    data: {titleKey: 'menu.music-sub.top'},
    children: [{path: ':filter', children: [], data: {titleKey: 'menu.music-sub.top'}}],
  },
