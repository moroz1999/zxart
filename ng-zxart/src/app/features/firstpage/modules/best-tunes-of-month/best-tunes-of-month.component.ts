...
const PLAYLIST_ID = 'firstpage-best-tunes-of-month';

@Component({
  selector: 'zx-fp-best-tunes-of-month',
  standalone: true,
  imports: [
    ZxTuneTableSkeletonComponent,
    CommonModule,
  ...
  templateUrl: './best-tunes-of-month.component.html',
  styleUrls: ['./best-tunes-of-month.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class BestTunesOfMonthComponent extends FirstpageModuleBase<ZxTuneDto> {
  readonly moduleType = 'bestTunesOfMonth' as const;
  ...
  protected loadData(): Observable<ZxTuneDto[]> {
    return this.dataService.getBestTunesOfMonth(this.settings.limit);
  }
