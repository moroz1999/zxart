...
export const MAIN_MENU: MenuEntry[] = [
  ...
  },
  {
    ...
    children: [
      ...
      {labelKey: 'menu.gfx.top', url: '/pictures', queryParams: {sorting: 'votes,desc'}, children: []},
  ...
  },
  {
    ...
    children: [
      ...
      {labelKey: 'menu.music-sub.top', url: '/music', queryParams: {sorting: 'votes,desc'}, children: []},
