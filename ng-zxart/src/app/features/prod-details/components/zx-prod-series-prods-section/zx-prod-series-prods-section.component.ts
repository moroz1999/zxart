...
import {ProdSeriesProdsApiService} from '../../services/prod-series-prods-api.service';
...
export class ZxProdSeriesProdsSectionComponent {
  ...
  constructor(
    private readonly api: ProdSeriesProdsApiService,
