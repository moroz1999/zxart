...
import {ProdCompilationItemsApiService} from '../../services/prod-compilation-items-api.service';
...
export class ZxProdCompilationItemsSectionComponent {
  ...
  constructor(
    private readonly api: ProdCompilationItemsApiService,
