...
ALTER TABLE `engine_module_zxrelease` CHANGE `releaseType` `releaseType` ENUM('unknown','original','rerelease','adaptation','localization','mod','crack','mia','corrupted','compilation','incomplete','demoversion','bugfix') CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL;