...
class dateTimeDataChunk extends DataChunk implements ElementStorageValueHolderInterface
{
    ...
    public function convertStorageToDisplay()
    {
        if ($this->storageValue > 0) {
            $this->displayValue = date('d.m.Y H:i', $this->storageValue);
        } else {
            $this->displayValue = '';
        }
    }
    ...
    {
        if ($this->storageValue > 0) {
            $this->formValue = date('d.m.Y H:i', $this->storageValue);
        } else {
            $this->formValue = '';
        }
    }
