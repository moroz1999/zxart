      ...
      <div className="va-hero">
        ...
        <div>
          ...
          <div className="va-hero__rating-row">
            ...
            <span style={{ fontSize: "var(--font-xs)", color: "var(--text-light-color)" }}>
              {PROD.rating.votes} голосов · в избранном у 18
            </span>
            <span style={{ marginLeft: "auto", fontSize: "var(--font-xs)", color: "var(--text-light-color)" }}>
              Добавлена {PROD.added}
            </span>
          </div>
