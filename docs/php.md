...
- Do NOT hide missing types behind helper wrappers, broadcasts or normalization layers added only for static analysis. Prefer fixing the contract or the nearest reasonable source of the mixed value, as long as that can be done without disproportionate refactoring.
