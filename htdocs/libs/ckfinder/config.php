...
function CheckAuthentication()
{
    ...
    try {
        ...
        $controller->setApplicationName('admin');
        if ($application = $controller->getApplication()) {
            if (($user = $application->getUser()) && $user->userName != 'anonymous') {
                $result = true;
            }
        }
    } catch (exception $e) {
...
*/
$controller = getController();
$baseUrl = $controller->domainURL . '/userfiles/';
...
$baseDir = $pathsManager->getPath('editorUploads');
