...
//        $this->prodsManager->setForceUpdateGroups(true);
    ...
    public function importAll()
    {
        ...
        if (is_file($this->getStatusPath()) && !$this->debugEntry) {
