...
<form action="{$element->getFormActionURL()}" class="form_component country_form" method="post" enctype="multipart/form-data">
	<table class='form_table'>
		...
		{/if}
		<tr class="{if $formErrors.joinCountry} form_error{/if}">
			<td class="form_label">
				{translations name='country.joincountry'}:
			</td>
			<td>
				<select class="country_form_jointag_select" name="{$formNames.joinCountry}" autocomplete='off'></select>
			</td>
		</tr>
	</table>
