...
{capture assign="moduleContent"}
	...
	{foreach $element->getPlaylists() as $playlist}
		<tr class="userplaylists_item">
			...
			<td class="userplaylists_item_delete_cell"><a class="userplaylists_item_delete button" href="{$playlist->URL}action:dele1te/id:{$playlist->id}/">{translations name="playlist.delete"}</a></td>
		</tr>
	{/foreach}
	</table>
{/capture}
